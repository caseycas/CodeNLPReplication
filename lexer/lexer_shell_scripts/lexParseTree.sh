...
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual/valid ../stopwords.txt ../../LSTM_data/eng_all_parse_manual/valid_text
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual/train ../stopwords.txt ../../LSTM_data/eng_all_parse_manual/train_text
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual/test ../stopwords.txt ../../LSTM_data/eng_all_parse_manual/test_text
...
mkdir -p ../../LSTM_data/eng_all_parse_manual_full_type/brown
mkdir -p ../../LSTM_data/eng_all_parse_manual_full_type/wsj
...
#Create the equivalent text only corpus
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual_full_type/valid ../stopwords.txt ../../LSTM_data/eng_all_parse_manual_full_type/valid_text
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual_full_type/train ../stopwords.txt ../../LSTM_data/eng_all_parse_manual_full_type/train_text
python ../reduceTreeToText.py ../../LSTM_data/eng_all_parse_manual_full_type/test ../stopwords.txt ../../LSTM_data/eng_all_parse_manual_full_type/test_text
...
#Create the equivalent text only corpus
python ../reduceTreeToText.py ../../LSTM_data/java_ast/test ../stopwords.txt ../../LSTM_data/java_ast/test_text --java_code
python ../reduceTreeToText.py ../../LSTM_data/java_ast/test_no_cap ../stopwords.txt ../../LSTM_data/java_ast/test_no_cap_text --java_code

python ../reduceTreeToText.py ../../LSTM_data/java_ast/train ../stopwords.txt ../../LSTM_data/java_ast/train_text --java_code
python ../reduceTreeToText.py ../../LSTM_data/java_ast/train_no_cap ../stopwords.txt ../../LSTM_data/java_ast/train_no_cap_text --java_code

python ../reduceTreeToText.py ../../LSTM_data/java_ast/valid ../stopwords.txt ../../LSTM_data/java_ast/valid_text --java_code
python ../reduceTreeToText.py ../../LSTM_data/java_ast/valid_no_cap ../stopwords.txt ../../LSTM_data/java_ast/valid_no_cap_text --java_code 
